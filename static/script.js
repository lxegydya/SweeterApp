  ...
  $.ajax({
    ...
    success: function (response) {
      if (response["result"] === "success") {
        ...
        if(posts.length == 0){
          $("#post-box").append(`
          <div class="box" id="no-post-yet">
              <p class="title is-1">Oops, there is no post in this App yet</p>
              <button class="button is-ghost" onclick='$("#modal-post").addClass("is-active")'>Create your own post!</button>
          </div>
          `)
          return;
        }
                  ...
                  <div class="media-content">
                      ...
                      <nav class="level is-mobile">
                          <div class="level-left">
                              <a class="level-item is-sparta" aria-label="heart" onclick="toggle_reaction('${post["_id"]}', 'heart')">
                                  <span class="icon is-small"><i class="fa ${class_heart}"
                                    aria-hidden="true"></i></span>&nbsp;<span class="like-num">${num2str(post["count_heart"])}</span>
                              </a>
                              <a class="level-item is-sparta" aria-label="star" onclick="toggle_reaction('${post["_id"]}', 'star')">
                                  <span class="icon is-small"><i class="fa ${class_star}"
                                    aria-hidden="true"></i></span>&nbsp;<span class="like-num">${num2str(post["count_star"])}</span>
                              </a>
                              <a class="level-item is-sparta" aria-label="thumbsup" onclick="toggle_reaction('${post["_id"]}', 'thumbsup')">
